...
class TobyFitResolutionSimulationTest(MantidStressTest):
    ...
    def runTest(self):
        ...
        # Oriented lattice & goniometer. Mantid axes are Beam=Z,Perp=X,Y=Up
        # The tobyfit lattice parameters have been permuted accordingly

        alatt = 5.51 
        blatt = 12.298
        clatt = 5.57
        uvec = [9.800000e-03,9.996000e-01,9.700000e-03]
        ...
        fake_data = CreateSimulationWorkspace(Instrument='MERLIN',BinParams=bins,UnitX='DeltaE',
                                              DetectorTableFilename='MER06399.raw')
        ...
        parameters = "Seff=0.7,J1a=38.7,J1b=-5.0,J2=27.3,SJc=10.0,GammaSlope=0.08,MultEps=0,TwinType=0,MCLoopMax=10"
